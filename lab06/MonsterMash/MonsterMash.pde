...
void setup()
{
   size(500,500);  // set the size of the drawing window
   m = new Monster(25, 25);  // create the Monster in the center of the screen
}

void draw()
{
   background(0,0,0);  // CHANGE this if you like
